---
title: Trabajos - KSBravo
description: Publicaciones en el Steam Workshop, videos de showcase y trabajo en s&box de KSBravo.
---

# Trabajos

Todo lo de abajo es público y jugable. Los encargos privados para creadores de contenido y dueños de servidores no se listan, pero son la mayor parte de lo que hacemos.
...
**SBHBase** es nuestra base de nextbots para s&box (Source 2): posesión, facciones, jumpscares, sistemas de ritmo y baile, efectos procedurales. El juego sandbox y las librerías están publicados en sbox.game bajo la organización `ksbravo`. Ver [Herramientas](tools.md).
